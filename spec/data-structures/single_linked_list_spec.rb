...
require_relative "../../data-structures/linked-list/single_linked_list"
...
describe SingleLinkedList do
  ...
  context "#to_s" do
    it "prints when list is empty" do
      expect(@linked_list.to_s).to eq("head")
    end
  end
  ...
  context "#push_front" do
    ...
    it "works properly" do
      expect(@linked_list.to_s).to eq("head-->3-->2-->1")
    end
  end
  ...
  context "#pop_front" do
    ...
    it "works properly" do
      ...
      expect(@linked_list.to_s).to eq("head-->2-->1")
  ...
  context "#push_back" do
    ...
    it "works properly" do
      expect(@linked_list.to_s).to eq("head-->5-->6-->7")
    end
  end
  ...
  context "#pop_back" do
    context "when it's not empty list" do
      ...
      it "works properly" do
        ...
        expect(@linked_list.to_s).to eq("head-->5-->6")
      end
    end
